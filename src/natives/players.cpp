...
namespace Natives
{
	...
	// native SetPlayerNPC(playerid, bool:npc);
	AMX_DECLARE_NATIVE(SetPlayerNPC)
	{
		CHECK_PARAMS(2, LOADED);
		...
		pNetGame->pPlayerPool->bIsNPC[playerid] = static_cast<BOOL>(CScriptParams::Get()->ReadInt());
		return 1;
	}
...
static AMX_NATIVE_INFO native_list[] =
{
	...
	AMX_DEFINE_NATIVE(SetPlayerNPC)
	...
	AMX_DEFINE_NATIVE(ResetPlayerMarkerForPlayer) // R18
