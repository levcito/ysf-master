...
public:
	...
	void ToggleNPCOnQuery(bool toggle) { m_bNPCOnQuery = toggle; }
	bool IsNPCOnQueryEnabled(void) { return m_bNPCOnQuery; }

	void ToggleNPCOnScoreboard(bool toggle) { m_bNPCOnScoreboard = toggle; }
	bool IsNPCOnScoreboardEnabled(void) { return m_bNPCOnScoreboard; }
	...
	void SetChatTextReplacement(int type) { m_iChatReplacement = type; };
	int GetChatTextReplacement() const { return m_iChatReplacement; };
