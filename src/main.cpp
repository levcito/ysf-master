...
PLUGIN_EXPORT bool PLUGIN_CALL Load(void ** ppData)
{
	...
	{
		logprintf("YSF cannot detect the running SA-MP version");
		logprintf("logprintf address is 0x%08X", ppData[PLUGIN_DATA_LOGPRINTF]);
	}
